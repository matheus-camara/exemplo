...
internal static class ProjectSeed
{
    ...
    {
        new(Guid.Parse("67630ab0-0f65-4757-884f-173b25f05633"), "Calculate the Dark Matter of the universe for Nasa",
            10),
        ...
        new(Guid.Parse("ab5150ce-b235-4454-b2b3-50d9fa1b9d04"),
            "Collect specific people information from their social media for XPTO Company", 2)
    };

    internal static void AddProjectSeed(this Context that)
    {
        foreach (var project in Data)
            if (!that.Set<Project>().Any(x => x.Id == project.Id))
                that.Add(project);
    }
}