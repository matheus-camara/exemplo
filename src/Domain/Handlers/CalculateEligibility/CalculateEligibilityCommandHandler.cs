...
{
    public class CalculateEligibilityCommandHandler : IRequestHandler<CalculateEligibilityForProCommand, CalculateEligibilityForProCommandResult>
    {
        ...
        public CalculateEligibilityCommandHandler(IProjectRepository projectRepository, IReferralCodeRepository referralCodeRepository, IEligibilityRepository eligibilityRepository, IMapper mapper)
        {
        ...
        public async Task<CalculateEligibilityForProCommandResult> Handle(CalculateEligibilityForProCommand request, CancellationToken cancellationToken)
        {
